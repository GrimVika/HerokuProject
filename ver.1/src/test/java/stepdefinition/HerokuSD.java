...
public class HerokuSD {
    ...
    public void iAmSignedInAsANewUser() throws InterruptedException {
        Assert.assertEquals((herokuLand.verifySuccessfullLogin()), ());}
    ...
    public void verifyNumberOfPosts (int expectedNum) {
        Assert.assertEquals((expectedNum), herokuLand.getNumberOfPosts());}
