...
public class HerokuLandingPage extends BasePage {
        ...
        public void verifyNumberOfPosts (int expectedNumOfPosts) {
        ...
        public void verifyPriceTags () {
            ...
            System.out.println("Tags with prices: " + tagsWithPrice);
            System.out.println("Tags without prices: " + tagsWithoutPrice);
            System.out.println("Total number of tags: " + priceTags.size());
        }
...
//        }
        ...
        public void verifyTitles () {
            ...
            System.out.println("Posts with title: " + postsWithTitle);
            System.out.println("Posts without title: " + postsWithoutTitle);
            System.out.println("Total number of posts: " + titles.size());
        }
        public void verifyPostImages () {
            ...
            System.out.println("Total images displayed: " + totalImgDisplayed);
            System.out.println("Images uploaded by users: " + uploadedImg);
        }
